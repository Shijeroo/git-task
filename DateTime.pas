...
//Часы в секунды
  var hours := ReadInteger('Введите часы которые хотите перевести в секунды: ');
  Assert(hours >= 0, 'Увы мы не можем найти секунды в отрицательных часах!');
  Print($'Кол-во секунд = {hours*3600}');
